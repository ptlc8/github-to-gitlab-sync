pipeline {
	...
	parameters {
		...
		string(name: 'MAX_REPOS', defaultValue: params.MAX_REPOS ?: null, description: 'Maximum number of repositories to sync (optional)')
		booleanParam(name: 'SKIP_ARCHIVED', defaultValue: params.SKIP_ARCHIVED ?: true, description: 'Skip archived repositories (optional)')
		booleanParam(name: 'SKIP_DISABLED', defaultValue: params.SKIP_DISABLED ?: true, description: 'Skip disabled repositories (optional)')
	} 
